...
// 1) users arrayinde firstname in sonu q ile biten name varsa logda versin yoxdursa
// error versin error message de q ile biten ad yoxdur yazilsin

// const result = () => {

//     try {
//         let name1 = users.filter((item) => item.firstName.endsWith("q"));
//         if (name1.length == 0) {
//             throw new Error("q ile biten soz yoxdur");
//         }
//         console.log("q ile biten sozler:", name1.map(item => item.firstName));
...
// olmasada butun istifadecilerin yaslari logda gorunsun


// const usersAge = () => {
//     try {
//         let age = users.filter(item => item.age > 100);
//         if (age.length == 0) {
...
// 3) ele bir function yaradinki parametr olaraq id verildiyinde id e gore istifadecini
// tapsin isdifadeci yoxdursa errorda id  tapilmadigi haqda melumat yazilsin

// const findId = (id) => {
//     try {
//         let person = users.find(item => item.id == id);
//         if (!person) {
//             throw new Error(`id ${id} Istifadeci yoxdur`);
//         }
//         console.log("istifadeci tapildi:", person);
//     } catch (error) {
//         console.error(error.message);
//     }
// }
...
// 4) parametrli function qurun id parametr olaraq verilsin ve ide gore hemin id de
// adress varmi deye yoxlasin eger varsa loga versin yoxdursa error versin ve bildirsinki
//  bu id li isdifadecinin adress melumati movcud deyil
...
// 5) id e gore parametrli func qurun ve gelen id e gore istifadecinin
// weight ve ya height her hansisa birisi yoxdursa boy ve ya kilo melumati eksikdi deye err versin

// const findUser = (id) => {
//     try {
//         let person = users.find(item => item.id == id)
//         if (!person) {
//             throw new Error(`id ${id} olan istifadeci tapilmadi`);
//         }
//         if (!person.height || !person.weight) {
//             throw new Error(`id ${id} olan istifadecinin boy ve ya kilo melumati eksikdir`);

//         } console.log(`id ${id} olan istifadecinin melumatlari`, {
